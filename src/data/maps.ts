...
export const maps: ValorantMap[] = [
    {
        ...
        featuredAgents: ["killjoy", "kayo", "jett", "omen", "sage"],
        smokes: [
            { id: "ascent-1", x: 33, y: 37, label: "B Main",   team: "attacker" },
            { id: "ascent-2", x: 39, y: 27.5, label: "Market", team: "attacker" },
            { id: "ascent-4", x: 72, y: 50, label: "A Main",   team: "defender" },
            { id: "ascent-5", x: 74.5, y: 38, label: "Tree",   team: "defender" },
        ],
    },
    {
        id: "haven",
        ...
        featuredAgents: ["jett", "breach", "killjoy", "omen", "skye"],
        smokes: [
    ...
    },
    {
        ...
        featuredAgents: ["cypher", "viper", "omen", "breach", "raze"],
        smokes: [
    ...
    },
    {
        ...
        featuredAgents: ["viper", "breach", "raze", "chamber", "skye"],
        smokes: [
    ...
    },
    {
        ...
        featuredAgents: ["viper", "sova", "chamber", "jett", "killjoy"],
        smokes: [
    ...
    },
    {
        ...
        featuredAgents: ["viper", "sova", "chamber", "jett", "fade"],
        smokes: [
    ...
    },
    {
        ...
        featuredAgents: ["breach", "kayo", "viper", "chamber", "raze"],
        smokes: [
    ...
    },
    {
        ...
        featuredAgents: ["harbor", "fade", "chamber", "jett", "killjoy"],
        smokes: [
    ...
    },
    {
        ...
        featuredAgents: ["brimstone", "breach", "chamber", "jett", "skye"],
        smokes: [
    ...
    },
    {
        ...
        featuredAgents: ["harbor", "fade", "chamber", "neon", "gekko"],
        smokes: [
    ...
    },
    {
        ...
        featuredAgents: ["clove", "jett", "fade", "killjoy", "gekko"],
        smokes: [
